        ...
        {exercises.length === 0 ? (
          ...
          <div style={{
            ...
            {exercises.map((ex, i) => {
              ...
              return (
                <div key={ex.id} style={{ background: '#fff', borderRadius: 12, overflow: 'hidden', border: `1.5px solid ${isV || isS ? mc.color + '35' : 'rgba(30,50,90,0.06)'}`, display: 'flex', flexDirection: 'column', transition: 'all .25s', minHeight: 0 }}>
                  <div style={{ height: 2, background: mc.stripe, flexShrink: 0 }} />
...
pathlib.Path(r"C:\nextapp\app\workout\components\PhasePrep.tsx").write_text(content, encoding="utf-8")
print("Done")